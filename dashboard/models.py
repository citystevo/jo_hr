...
class Loan(models.Model):
    ...
    amount = models.DecimalField(
        ...
        decimal_places=2,
        validators=[
            MinValueValidator(1, message="Loan amount must be greater than zero"),
            MaxValueValidator(1000000, message="Loan amount cannot exceed ₦1,000,000")
        ]
    )
    start_date = models.DateField()
    end_date = models.DateField()
    ...
    def formatted_amount(self):
        return f"₦{intcomma('{:.2f}'.format(self.amount))}" if self.amount else ''
